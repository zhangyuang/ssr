...
const getBaseConfig = (chain: WebpackChain, isServer: boolean) => {
  ...
  const { moduleFileExtensions, chainBaseConfig, locale, corejsOptions, ssrVueLoaderOptions, csrVueLoaderOptions, babelExtraModule, alias, define, babelOptions } = config
